...
{
    public class CancelOrderKafkaMessagePublisher : OrderCancelledPaymentRequestMessagePublisher
    {
        ...
        public CancelOrderKafkaMessagePublisher(ILogger<CreateOrderKafkaMessagePublisher> logger, OrderMessagingDataMapper orderMessagingDataMapper, OrderServiceConfigData orderServiceConfigData, KafkaProducer kafkaProducer
        ...
        public void Publish(OrderCancelledEvent domainEvent)
        {
            ...
            try
            {
                _logger.LogInformation("Received OrderCancelEvent for order id: {OrderId}", orderId);
